...
export function VideoFeature({ videoId, title }: VideoFeatureProps) {
  ...
  // loop requires playlist=<same id> on YouTube embeds
  ...
  // Autoplay when the video scrolls into view (keeps the first paint light)
  useEffect(() => {
    if (active) return;
        ...
        {active ? (
          ...
          >
            ...
            <span className="absolute inset-0 flex items-center justify-center">
              <span className="flex h-16 w-16 items-center justify-center rounded-full bg-[hsl(var(--nav-theme)/0.9)] shadow-lg ring-4 ring-white/20 transition-transform group-hover:scale-110">
