...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Terms of Service - Marvel Rivals Season 9 Wiki',
    description: 'Read the Terms of Service for Marvel Rivals Season 9 Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our hero shooter resource platform.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Terms of Service - Marvel Rivals Season 9 Wiki',
      description: 'Terms and conditions for using Marvel Rivals Season 9 Wiki.',
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Marvel Rivals Season 9 Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Marvel Rivals Season 9 Wiki (&quot;the Website&quot;, &quot;we&quot;, &quot;our&quot;, or &quot;us&quot;), you agree to be bound
              by these Terms of Service (&quot;Terms&quot;). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you (&quot;User&quot;, &quot;you&quot;, or &quot;your&quot;) and Marvel Rivals Season 9 Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Marvel Rivals Season 9 Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the 6v6 super hero team shooter &quot;Marvel Rivals&quot;. Our services include, but are not limited to:
            </p>
            <ul>
              <li>Hero guides, abilities, and strategy breakdowns</li>
              <li>Tier lists and meta analysis</li>
              <li>Season 9 &quot;Mystery of Thebes&quot; coverage and patch notes</li>
              <li>Map and game mode guides</li>
              <li>Active redeem codes for free cosmetics and rewards</li>
              <li>Community discussion and content</li>
            </ul>
            <p>
              <strong>Important:</strong> Marvel Rivals Season 9 Wiki is NOT affiliated with, endorsed by, or associated with
              NetEase Games, Marvel Entertainment, or Valve Corporation (Steam). We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Marvel Rivals Season 9 Wiki and are protected by international
              copyright, trademark, and other intellectual property laws.
            </p>

            <h3>4.2 Game Content</h3>
            <p>
              All game-related content, including but not limited to hero images, game screenshots, logos, and
              trademarks, are the property of NetEase Games, Marvel Entertainment, and/or Valve Corporation (Steam). We use such
            ...
            <ul>
              <li><strong>Accuracy:</strong> We strive to provide accurate information, but we do not guarantee that all content is current, complete, or error-free. Hero balances and game updates may render information outdated.</li>
              ...
              <li><strong>Redeem Codes:</strong> Active redeem codes may expire or change without notice. We are not responsible for codes that no longer work or for game changes made by NetEase Games.</li>
            </ul>
            <p>
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, MARVEL RIVALS SEASON 9 WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              The Website may contain links to third-party websites, including Steam, Discord, Reddit, YouTube, social media platforms,
            ...
            <p>
              ...
              you and Marvel Rivals Season 9 Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@marvelrivalsseason9.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@marvelrivalsseason9.wiki</a>
            </p>
            <p>
