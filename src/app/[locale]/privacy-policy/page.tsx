...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Privacy Policy - Marvel Rivals Season 9 Wiki',
    description: 'Marvel Rivals Season 9 Wiki Privacy Policy. Learn how we collect, use, and protect your data when you use our hero shooter resource platform. Your privacy matters to us.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Marvel Rivals Season 9 Wiki (&quot;we&quot;, &quot;our&quot;, or &quot;us&quot;) collects minimal information to provide and improve our services.
            ...
            <p>
              Our website may contain links to external websites, including Steam, Discord, Reddit, YouTube, and other social media platforms.
            ...
            <h2>11. Disclaimer</h2>
            <p>
              Marvel Rivals Season 9 Wiki is an unofficial fan-made website and is not affiliated with, endorsed by, or associated
              with NetEase Games (developer of Marvel Rivals), Marvel Entertainment, or Valve Corporation (Steam). All game content, trademarks, and assets are
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:privacy@marvelrivalsseason9.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">privacy@marvelrivalsseason9.wiki</a>
            </p>
            <p>
